...
const EconomicGrowthChart = ({
  ...
  return (
    <Collapsible.Root asChild>
      <section className="card economic-growth-chart education-dropdown">
        ...
        <p className="nearby-colleges-intro education-dropdown-summary">
          Review annual employment growth and current indicators for
          unemployment, wages, hiring, separations, and regional GDP.
        </p>
        {active && (
          <div className="growth-active-value employment-growth-preview">
            <strong>
        ...
        <Collapsible.Content className="education-dropdown-content">
          ...
          <p className="sector-source-note">
            ...
            Statistics (LAUS). Annual values are monthly city-employment
            averages; Current-year estimates extend the latest reported
            employment using the most recent BLS QCEW covered-job growth rate
            and are marked “est.” This is resident employment growth, not GDP
            growth.
          </p>
