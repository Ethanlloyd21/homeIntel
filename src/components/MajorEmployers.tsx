...
const MajorEmployers = ({
  ...
  return (
    <Collapsible.Root asChild>
      <section className="card major-employers education-dropdown">
        ...
        <p className="nearby-colleges-intro education-dropdown-summary">
          Explore major employers and industries in the surrounding area.
        </p>
        <Collapsible.Content className="education-dropdown-content">
          ...
          <p className="sector-source-note">
            ...
            of performance, Wikidata's CC0 knowledge base, and the U.S.
            Hospitals HIFLD feature service. Federal totals cover the latest
            three years and indicate regional contract activity, not local
            employee counts. Hospital beds, staff, and websites appear when
